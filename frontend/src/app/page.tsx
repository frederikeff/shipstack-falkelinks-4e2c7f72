...
export default function Home() {
  const projects = [
    {
      ...
      title: "Nxtconnect",
      imageSrc:
        "https://ui-avatars.com/api/?name=NxtConnect&size=400&background=6366f1&color=fff&bold=true",
    },
    {
      href: "https://www.creativeailab.ai",
      title: "Creative Ai Lab",
      imageSrc:
        "https://ui-avatars.com/api/?name=Creative+AI+Lab&size=400&background=6366f1&color=fff&bold=true",
    },
    {
      href: "https://www.shaped.ai",
      title: "Shaped.ai",
      imageSrc:
        "https://ui-avatars.com/api/?name=Shaped&size=400&background=ec4899&color=fff&bold=true",
    },
  ];
  ...
  const labs = [
    ...
    {
      href: "https://www.creativeailab.ai/character-lab",
      title: "Character Lab",
    },
    {
      href: "https://www.creativeailab.ai/research-lab",
      title: "Research Lab",
    },
  ...
  const handleEmailClick = () => {
    trackClick("mailto:hi@creativeailab.ai", "Email Me");
  };
